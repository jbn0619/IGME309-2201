...
void AppClass::Run(void)
{
	...
	glClearColor(0.97f, 1.0f, 0.86f, 1.0f);
	...
	while (m_bRunning)
	{
		...
		while (m_pWindow->pollEvent(event))
		{
			...
			{	
				...
				if (isComplementary)
				{
					//m_v3Color = glm::vec3(1.0f - m_v3Color.r, 1.0f - m_v3Color.b, 1.0f - m_v3Color.g);
					m_uShaderProgramID = LoadShaders("Shaders//ComplimentaryColor.vs", "Shaders//ComplimentaryColor.fs");
...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	...
	else if (a_event.key.code == sf::Keyboard::Key::Space) 
	{
